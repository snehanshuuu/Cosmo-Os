...
export const CyberCatCompanion: React.FC = () => {
  ...
  return (
    <div
      onClick={handleClick}
      className="fixed bottom-5 left-5 z-30 flex flex-col items-start cursor-pointer select-none group"
    ...
    >
      ...
      <AnimatePresence>
        {showSpeech && (
          <motion.div
            ...
            className="mb-2 max-w-xs p-2.5 rounded-2xl bg-black/85 border border-cosmos-lime/50 text-cosmos-lime-bright text-xs font-mono shadow-[0_0_15px_rgba(124,255,0,0.25)] backdrop-blur-md relative"
          >
      ...
      {/* Cyber Cat Character Icon (Extreme Bottom Left) */}
      <motion.div
        ...
        className="w-12 h-12 rounded-2xl bg-black/80 border-2 border-cosmos-lime/70 p-1.5 flex items-center justify-center relative shadow-[0_0_20px_rgba(124,255,0,0.35)] group-hover:border-cosmos-lime group-hover:shadow-[0_0_25px_rgba(124,255,0,0.6)] transition-all"
      >
